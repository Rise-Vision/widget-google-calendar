    ...
    casper.then(function () {
      ...
      function then() {
        ...
        test.assertEquals(this.getHTML(".day:nth-child(5) .event:nth-child(1) .time"), this.evaluate(function() {
          return moment().hour(7).minute(0).second(0).format("h:mma") + " - " + moment().hour(8).minute(0).second(0).format("h:mma");
        }), "Event 1 month from now has an end time");
      });
    });
